...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    url='https://github.com/NaN-tic/trytond-sale_line_invoice_comment',
    download_url='https://github.com:nantic/trytond-sale_line_invoice_comment.git',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-sale_line_invoice_comment.git'
    },
    classifiers=[
